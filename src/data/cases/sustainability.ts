...
export const sustainabilityCase: CaseStudy = {
  ...
  exhibits: [
    {
      ...
      data: [
        ...
        { metric: "Annual energy cost saving", value: "$8,000,000" },
    ...
    },
    {
      id: "ex-abatement",
      kind: "bar",
      title: "Exhibit 2: Abatement Options ($ cost per tonne CO2 avoided)",
      note: "Negative cost = net savings. Bubble size in source data omitted.",
      categoryKey: "lever",
      series: [{ key: "costPerTonne", label: "$ / tonne CO2" }],
      data: [
        { lever: "LED lighting retrofit", costPerTonne: -60 },
        { lever: "On-site solar", costPerTonne: -25 },
        { lever: "Fleet electrification", costPerTonne: 35 },
        { lever: "Green hydrogen heating", costPerTonne: 210 },
      ],
    },
    {
      id: "ex-emissions",
  ...
  questions: [
    ...
    },
    {
      ...
      dimension: "quant",
      prompt:
        "Casey: Over its 25-year life, how much total CO2 does the solar program avoid (120,000 tonnes/yr)? Answer in tonnes.",
      exhibitRefs: ["ex-solar"],
      timeLimitSec: 120,
      expectedValue: 3000000,
      tolerance: 0,
      unitHint: "tonnes",
      rubric: "120,000 t/yr x 25 yrs = 3,000,000 tonnes.",
      modelAnswer: "120,000 x 25 = 3,000,000 tonnes.",
    },
    {
      id: "sustain-q8",
      format: "single",

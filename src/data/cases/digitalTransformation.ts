...
export const digitalTransformationCase: CaseStudy = {
  ...
  exhibits: [
    {
      ...
      columns: [
        ...
        { key: "cost", label: "Cost / transaction" },
      ],
      data: [
        { channel: "Branch (teller)", cost: "$4.25" },
        { channel: "Call center", cost: "$2.40" },
        { channel: "ATM", cost: "$0.85" },
        { channel: "Digital (app/web)", cost: "$0.10" },
      ],
    },
    {
      id: "ex-mix",
    ...
    },
    {
      id: "ex-adopt",
      kind: "bar",
      title: "Exhibit 3: Digital Adoption by Customer Age (%)",
      hardModeOnly: true,
      categoryKey: "age",
      series: [{ key: "adoption", label: "% using app" }],
      data: [
        { age: "18-34", adoption: 82 },
        { age: "35-54", adoption: 61 },
        { age: "55-69", adoption: 34 },
        { age: "70+", adoption: 12 },
      ],
    },
  ],
  questions: [
    ...
    },
    {
      ...
      dimension: "quant",
      prompt:
        "Casey: Using Exhibit 2, how many transactions are currently done at the branch (out of 120M)? Answer in transactions.",
      exhibitRefs: ["ex-mix"],
      timeLimitSec: 120,
      expectedValue: 42000000,
      tolerance: 0,
      unitHint: "transactions",
      rubric: "35% x 120M = 42,000,000 branch transactions.",
      modelAnswer: "35% x 120M = 42M branch transactions.",
    },
    {
      id: "digital-q3",
      format: "single",
